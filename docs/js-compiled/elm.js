...
var $author$project$Pages$Home = {$: 'Home'};
var $author$project$Pages$InvalidPage = {$: 'InvalidPage'};
var $author$project$Pages$getCurrentPageFromString = function (currentPageString) {
	if (currentPageString === 'home') {
		return $author$project$Pages$Home;
	} else {
		return $author$project$Pages$InvalidPage;
	}
};
var $author$project$Flags$initFlags = function (flags) {
	return {currentPage: flags.currentPage};
};
var $author$project$Model$initModel = F3(
	function (flags, url, key) {
		var currentPage = $author$project$Pages$getCurrentPageFromString(flags.currentPage);
		return {
			currentPage: currentPage,
			flags: $author$project$Flags$initFlags(flags),
			key: key,
			url: url
		};
	});
...
var $author$project$View$viewPageData_DELETEMELATER = function (pageData) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(pageData.title),
				$mdgriffith$elm_ui$Element$text(
				A2($elm$core$Maybe$withDefault, 'NOTHING', pageData.desc))
			]));
};
var $author$project$View$pageViewHelper = function (currentPage) {
	var pageData = $author$project$Pages$getCurrentPageData(currentPage);
	return $author$project$View$viewPageData_DELETEMELATER(pageData);
};
...
var $author$project$View$viewHelper = function (model) {
	return A2(
		...
		$author$project$View$pageViewHelper(model.currentPage));
};
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Init$init, onUrlChange: $author$project$Msg$OnUrlChange, onUrlRequest: $author$project$Msg$OnUrlRequest, subscriptions: $author$project$Subscriptions$subscriptions, update: $author$project$Update$update, view: $author$project$View$view});
