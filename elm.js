...
{
	if (region.aN.ae === region.a$.ae)
	{
		return 'on line ' + region.aN.ae;
	}
	return 'on lines ' + region.aN.ae + ' through ' + region.a$.ae;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cy: 'hidden', cd: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cy: 'mozHidden', cd: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cy: 'msHidden', cd: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cy: 'webkitHidden', cd: 'webkitvisibilitychange' }
		: { cy: 'hidden', cd: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a4: fragment, a9: host, bo: path, bq: port_, bt: protocol, bu: query};
	});
...
var $mdgriffith$elm_ui$Internal$Style$classes = {bO: 'a', ax: 'atv', bQ: 'ab', bR: 'cx', bS: 'cy', bT: 'acb', bU: 'accx', bV: 'accy', bW: 'acr', aT: 'al', aU: 'ar', bX: 'at', ay: 'ah', az: 'av', bZ: 's', b2: 'bh', b3: 'b', aV: 'w7', b7: 'bd', b8: 'bdt', al: 'bn', b9: 'bs', am: 'cpe', ce: 'cp', cf: 'cpx', cg: 'cpy', C: 'c', ao: 'ctr', ap: 'cb', aq: 'ccx', D: 'ccy', ab: 'cl', ar: 'cr', cl: 'ct', cm: 'cptr', cn: 'ctxt', cv: 'fcs', a3: 'focus-within', cw: 'fs', cx: 'g', aD: 'hbh', aE: 'hc', a7: 'he', aF: 'hf', a8: 'hfp', cz: 'hv', cB: 'ic', cD: 'fr', at: 'lbl', cF: 'iml', cG: 'imlf', cH: 'imlp', cI: 'implw', cJ: 'it', cK: 'i', be: 'lnk', W: 'nb', bh: 'notxt', cN: 'ol', cP: 'or', O: 'oq', cT: 'oh', bl: 'pg', bn: 'p', cU: 'ppe', cX: 'ui', t: 'r', cZ: 'sb', c_: 'sbx', c$: 'sby', c0: 'sbt', c2: 'e', c3: 'cap', c4: 'sev', da: 'sk', dd: 't', de: 'tc', dg: 'w8', dh: 'w2', di: 'w9', dj: 'tj', aw: 'tja', dk: 'tl', dl: 'w3', dm: 'w5', dn: 'w4', $7: 'tr', dp: 'w6', dq: 'w1', dr: 'tun', bD: 'ts', R: 'clr', aj: 'u', aP: 'wc', bJ: 'we', aQ: 'wf', bK: 'wfp', aR: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.bZ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cx);
...
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.bZ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bn);
...
var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
	switch (style.$) {
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.t) + ('-' + ($elm$core$String$fromInt(pos.ck) + ('-' + ($elm$core$String$fromInt(pos.bI) + ('-' + $elm$core$String$fromInt(pos.a6)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cz, $mdgriffith$elm_ui$Internal$Style$classes.O)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cv, $mdgriffith$elm_ui$Internal$Style$classes.R)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cv, $mdgriffith$elm_ui$Internal$Style$classes.O)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {an: closing, i: _List_Nil, G: _List_Nil, u: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.u + ('{' + (renderValues(rule.G) + (rule.an + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.t) + (' / ' + ($elm$core$String$fromInt(position.t + position.a6) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.ck) + (' / ' + ($elm$core$String$fromInt(position.ck + position.bI) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.t) + ('-' + ($elm$core$String$fromInt(position.ck) + ('-' + ($elm$core$String$fromInt(position.bI) + ('-' + $elm$core$String$fromInt(position.a6)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.c3 + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.dd + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.c3 + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.dd)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a6: height / size, X: size, bG: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cc, adjustment.b1, adjustment.cp, adjustment.cL]);
	var lineHeight = 1.5;
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bZ, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.D, $mdgriffith$elm_ui$Internal$Style$classes.bW])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.bZ, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.ao, $mdgriffith$elm_ui$Internal$Style$classes.D, $mdgriffith$elm_ui$Internal$Style$classes.bU])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.bZ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dd + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aP + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aE)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.bZ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dd + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aF)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.bO]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.b3]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.cP]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.cN]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.cD]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.W, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.b2]));
						}
					}())
				]),
			_List_fromArray(
...
var $author$project$Examples$HomePageExamples$example1 = function () {
	...
	return {
		ch: exampleCode,
		co: $elm$core$Maybe$Just('A normal label'),
		df: '\n    paragraph []\n        [ text <| "Example 1" ]\n    ',
		dt: 'This is the title'
	};
}();
...
var $author$project$Pages$getCurrentPageData = function (currentPage) {
	return {
		co: $author$project$Pages$getDescOfCurrentPage(currentPage),
		a1: $author$project$Pages$getExamplesListOfCurrentPage(currentPage),
		dt: $author$project$Pages$getTitleOfCurrentPage(currentPage)
	};
};
var $author$project$Pages$Home = 0;
var $author$project$Pages$InvalidPage = 1;
var $author$project$Pages$getCurrentPageFromString = function (currentPageString) {
	if (currentPageString === 'home') {
		return 0;
	} else {
		return 1;
	}
};
var $author$project$Flags$initFlags = function (flags) {
	return {aB: flags.aB};
};
var $author$project$Model$initModel = F3(
	function (flags, url, key) {
		var currentPage = $author$project$Pages$getCurrentPageFromString(flags.aB);
		var pageData = $author$project$Pages$getCurrentPageData(currentPage);
		return {
			aB: currentPage,
			a2: $author$project$Flags$initFlags(flags),
			bc: key,
			bm: pageData,
			bE: url
		};
...
var $author$project$Styles$Colors$colors = {
	b$: A3($mdgriffith$elm_ui$Element$rgb255, 250, 243, 217),
	b4: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 255),
	ci: A3($mdgriffith$elm_ui$Element$rgb255, 59, 59, 59),
	cj: A3($mdgriffith$elm_ui$Element$rgb255, 213, 213, 213),
	cV: A3($mdgriffith$elm_ui$Element$rgb255, 255, 0, 0),
	dd: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
	dt: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
	dy: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)
};
var $author$project$Styles$Styles$backgoundColor = $author$project$Styles$Colors$colors.b$;
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cv: $elm$core$Maybe$Nothing, cz: $elm$core$Maybe$Nothing, cM: $elm$core$Maybe$Nothing},
			options));
};
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cl + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ab)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.aV);
...
var $author$project$Styles$Styles$descAttr = $author$project$Styles$Font$descAttr(
	{aV: false});
var $author$project$View$descView = function (desc) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
...
var $author$project$Styles$Font$codeOutputAttr = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$Colors$colors.dy),
		$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$Styles$Font$codeblockFont = $elm$core$Maybe$Just(
	{aI: 'Fira Code ', bE: 'https://fonts.googleapis.com/css2?family=Fira+Code&display=swap'});
...
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aj);
var $author$project$Styles$Font$fontAttrTemplate = function (config) {
	return _Utils_ap(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$size(config.ad),
				config.aj ? $mdgriffith$elm_ui$Element$Font$underline : $mdgriffith$elm_ui$Element$Font$regular
			]),
		function () {
			var _v0 = config.ac;
			if (_v0.$ === 1) {
...
var $author$project$Styles$Font$codeblockAttr = _Utils_ap(
	$author$project$Styles$Font$fontAttrTemplate(
		{ac: $author$project$Styles$Font$codeblockFont, ad: $author$project$Styles$Font$codeblockFontSize, aj: false}),
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			A2($mdgriffith$elm_ui$Element$paddingXY, 30, 20),
			$mdgriffith$elm_ui$Element$Border$rounded(10),
			$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$Colors$colors.ci),
			$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$Colors$colors.cj)
		]));
...
var $author$project$Styles$Font$titleFont = $elm$core$Maybe$Just(
	{aI: 'Montserrat', bE: 'https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,700;1,700&display=swap'});
var $author$project$Styles$Font$subsubtitleAttr = $author$project$Styles$Font$fontAttrTemplate(
	{ac: $author$project$Styles$Font$titleFont, ad: $author$project$Styles$Font$subsubtitleFontSize, aj: false});
	...
	function (index, example) {
		var exampleTitleView = A2(
			...
			_List_fromArray(
				[
					...
					'#' + ($elm$core$String$fromInt(index + 1) + (' : ' + example.dt)))
				]));
		var exampleDescView = A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text(
					A2($elm$core$Maybe$withDefault, '', example.co))
				]));
		var exampleCodeblockView = A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(example.df)
						]))
				]));
...
var $author$project$Styles$Font$subtitleAttr = $author$project$Styles$Font$fontAttrTemplate(
	{ac: $author$project$Styles$Font$noSpecialFont, ad: $author$project$Styles$Font$subtitleFontSize, aj: true});
...
var $author$project$Styles$Font$titleAttr = $author$project$Styles$Font$fontAttrTemplate(
	{ac: $author$project$Styles$Font$titleFont, ad: $author$project$Styles$Font$titleFontSize, aj: true});
...
var $author$project$View$titleView = function (title) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			$author$project$Styles$Styles$titleAttr,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX])),
		$mdgriffith$elm_ui$Element$text(title));
};
var $author$project$View$pageViewHelper = function (pageData) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$paddingEach(
				{aW: 20, bd: 30, bx: 30, bC: 100}),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$spacing(60)
			]),
		_List_fromArray(
			[
				$author$project$View$titleView(pageData.dt),
				$author$project$View$descView(
				A2($elm$core$Maybe$withDefault, '', pageData.co)),
				$author$project$View$examplesView(pageData.a1)
			]));
};
var $author$project$View$viewHelper = function (model) {
	return A2(
		...
		$author$project$View$pageViewHelper(model.bm));
};
	...
	return {
		b5: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$Styles$backgoundColor)
					]),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{cE: $author$project$Init$init, cQ: $author$project$Msg$OnUrlChange, cR: $author$project$Msg$OnUrlRequest, dc: $author$project$Subscriptions$subscriptions, dw: $author$project$Update$update, dx: $author$project$View$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'currentPage', $elm$json$Json$Decode$string)))(0)}});}(this));